...
gsutil rm gs://us-east1-production-41653310-bucket/dags/sql/fields_of_study_v2/*
gsutil cp sql/* gs://us-east1-production-41653310-bucket/dags/sql/fields_of_study_v2/
gsutil cp schemas/* gs://airflow-data-exchange/fields_of_study_v2/schemas/
gsutil cp schemas/* gs://us-east1-production-41653310-bucket/dags/schemas/fields_of_study_v2/
gsutil cp query_sequence.txt gs://us-east1-production-41653310-bucket/dags/sequences/fields_of_study_v2/
