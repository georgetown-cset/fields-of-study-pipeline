...
if __name__ == '__main__':
    ...
    parser.add_argument('--bq_dest', type=str, help='Dataset in BQ where data should be written')
    parser.add_argument('--extract_bucket', type=str, help='Bucket in GCS where exported jsonl should be written')
