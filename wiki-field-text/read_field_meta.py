...
Optionally, we restrict to fields in a level range (by default 0-2) to cut down on the time we'll later spend hitting
the API (see ``main.py``). There are just ~138K fields in levels 0-2, compared to more than 700K overall.
