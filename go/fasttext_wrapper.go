/*
This is a Go wrapper for the fastText C++ library.

https://github.com/taufik-rama/fasttext-go-wrapper
*/
package main

// #cgo LDFLAGS: -L${SRCDIR}/fasttext-go-wrapper/fastText/lib -lfasttext-wrapper -lstdc++ -lm -pthread
// #include <stdlib.h>
...
// NewModel should be used to instantiate the model.
