...
as (
  ...
  select
    ...
    array_agg(
      ...
      any_value(if(level = 0 and field_rank = 0, name, null)) top_l0,
      any_value(if(level = 1 and field_rank = 0, name, null)) top_l1,
      any_value(if(level = 2 and field_rank = 0, name, null)) top_l2,
      any_value(if(level = 3 and field_rank = 0, name, null)) top_l3,
